                                        ...
                                        <table id="example1" class="table table-bordered table-striped dataTable"
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    ...
                                                    style="width: 20%;">Vendor
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1" aria-label="Import Date: activate to sort column ascending"
                                                    style="width: 20%;">Import Date
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                            ...
                                            @foreach($imports as $key => $import)
                                                <tr>
                                                    ...
                                                    <td style="display: flex">
                                                        <a href="{{route('imports.edit', $import->id)}}"><button class="btn btn-outline-warning">Edit</button></a>
