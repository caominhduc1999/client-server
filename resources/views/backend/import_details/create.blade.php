        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add Import Detail</h3>
                ...
                <div class="card-body">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="{{ route('import_details.store') }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" name="import_price" class="form-control" id="exampleInputEmail1" value="{{old('import_price')}}">
